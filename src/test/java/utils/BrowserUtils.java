...
public class BrowserUtils {
    public static void selectBy(WebElement location, String value, String methodName) {
        ...
        switch (methodName) {
            case "text":
                ...
                break;// !! very important, becouse case is FAIL
            case "value":
            ...
            default:
                ...
                // we do not need break after dafault
        }
    ...
    public static String getText(WebElement element) {
        ...
        return element.getText().trim(); // using TRIM in a frame work is not profeccional
    ...
    public static void switchById(WebDriver driver) { // works only with 2 windows
        ...
        if(scenario.isFailed()){
            ...
            try {
                FileUtils.copyFile(screenShotFile,
                            new File("src/test/java/screenshot/"+screenShotFileName+".png"));
            } catch (IOException e) {
